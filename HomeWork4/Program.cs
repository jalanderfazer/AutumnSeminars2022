...
// Не вполне поняла, что подразумевается под "задает массив из 8 чисел", если  рандомайзером - то FillArray можно было бы сделать проще через array[i] = new Random.Next(1,10)), по идее.